            ...
            <VContainer fluid class="d-flex align-center justify-center fill-height" :max-width="896">
                <VCard width="100%" border rounded>
                    <VRow>
                        ...
                        <VDivider vertical />
                        <VCol cols="12" md="6" class="pl-0 pb-0" :style="{ backgroundColor: '#1d0002' }">
                            <svg viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg" :style="{ color: '#f61500' }">
                            ...
                            <div :style="{ marginTop: '-6.6rem' }">
                                <svg v-if="false" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
