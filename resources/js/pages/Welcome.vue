...
<template>
    <Head title="Welcome" />
    <VApp>
        <VAppBar class="bg-transparent" flat :height="100">
            <VContainer fluid :max-width="896" class="d-flex justify-end ga-3">
                <VBtn v-if="$page.props.auth.user" :to="route('dashboard')" text="Dashboard" />
                <template v-else>
                    <VBtn :to="route('login')" text="Log in" />
                    <VBtn :to="route('register')" text="Register" variant="outlined" />
                </template>
            </VContainer>
        </VAppBar>
        <VMain>
            <VContainer fluid class="d-flex align-center justify-center fill-height" :max-width="896">
                <VCard width="100%" border rounded>
                    <VRow>
                        <VCol cols="12" md="6" class="d-flex align-center justify-center flex-grow-1">
                            <div class="px-2 py-4">
                                <h1 class="mb-1 text-body-2">Let's get started</h1>
                                ...
                                <ul class="ml-4 mb-6 text-body-2">
                                    <li class="my-3">
                                        Read the
                                        <a
                                            href="https://laravel.com/docs"
                                            target="_blank"
                                            class="text-primary d-inline-flex text-decoration-none align-center ga-1"
                                        >
                                            <span class="text-decoration-underline">Documentation</span>
                                            <VIcon icon="mdi-arrow-top-right" size="11" />
                                        </a>
                                    </li>
                                    <li class="my-3">
                                        ...
                                        <a
                                            ...
                                            class="text-primary d-inline-flex text-decoration-none align-center ga-1"
                                        >
                                            <span class="text-decoration-underline">Laracasts</span>
                                            <VIcon icon="mdi-arrow-top-right" size="11" />
                                        </a>
                                    </li>
                                </ul>

                                <VBtn href="https://cloud.laravel.com/" text="Deploy now" target="_blank" variant="tonal" />
                            </div>
                        </VCol>
                        <VDivider vertical />
                        <VCol
                            ...
                            class="pl-0 pb-0"
                            :style="{
                                backgroundColor: $vuetify.theme.name === 'light' ? '#fff2f2' : '#1d0002',
                            }"
                        >
                            <svg viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-primary">
                            ...
                            <div :style="{ marginTop: '-6.6rem' }">
                                <svg v-if="$vuetify.theme.name === 'light'" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                                ...
                                <svg v-else viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                                            d="M188.263 355.73L188.595 355.73C195.441 348.845 205.766 339.761 219.569 328.477C232.93 317.193 242.978 308.205 249.714 301.511C256.34 294.626 260.867 287.358 263.296 279.708C265.725 272.058 264.565 264.121 259.816 255.896C254.516 246.716 247.062 239.352 237.454 233.805C227.957 228.067 217.908 225.198 207.307 225.198C196.927 225.197 190.136 227.97 186.934 233.516C183.621 238.872 184.726 246.331 190.247 255.894L125.647 255.891C116.371 239.825 112.395 225.481 113.72 212.858C115.265 200.235 121.559 190.481 132.602 183.596C143.754 176.52 158.607 172.982 177.159 172.983C196.594 172.984 215.863 176.523 234.968 183.6C253.961 190.486 271.299 200.241 286.98 212.864C302.661 225.488 315.14 239.833 324.416 255.899C333.03 270.817 336.841 283.918 335.847 295.203C335.075 306.487 331.376 316.336 324.75 324.751C318.346 333.167 308.408 343.494 294.936 355.734L377.094 355.737L405.917 405.656L217.087 405.649L188.263 355.73Z"
                                            fill="black"
